...
3. Install Virtual Environment:
  ...
  3.2 Manual:
  ####
  3.2.1 CTRL+ALT+S > Project: [project name] > Python Interpreter > click on the setting icon on the top right > add > OK
  ####
  ![image](https://user-images.githubusercontent.com/45327886/124458680-efebb680-dd95-11eb-9a6c-e97fb2278cab.png)
  ####
  3.2.2 Install the packages inside the file "requirmenets.txt".
  ####
...
####
4. Then on the right windows select 'Save All Events As...' then type a name and select as XML file. 
####
